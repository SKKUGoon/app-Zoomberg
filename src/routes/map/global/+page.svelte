<script lang="ts">
	...
	import { buildMapMarkers, getNumericCoords } from '$lib/domain/markerBuilder';
	...
	import type { GlobeFocusTarget, GlobeRelationshipOverlay, NewsCard } from '$lib/types/news';
	...
	const mapContextLabel = 'Global Context';
